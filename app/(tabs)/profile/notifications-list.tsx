...
export default function NotificationsListScreen() {
  ...
  const handleNotificationPress = useCallback((groupedNotification: GroupedNotification) => {
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptySubtitle}>
        Cuando alguien interactúe con tu contenido, las notificaciones aparecerán aquí
      </Text>
    </View>
  );
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <FlatList
        ...
        contentContainerStyle={groupedNotifications.length === 0 ? styles.emptyListContent : undefined}
      />
    </SafeAreaView>
  );
}
